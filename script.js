...
document.getElementById("form").addEventListener("submit", function(event) {
    ...
    var total = parseFloat((parseFloat(complexity) + parseFloat(uncertainty) + parseFloat(security) + parseFloat(controls) + parseFloat(familiarity) + parseFloat(quality) + parseFloat(dependencies) + parseFloat(performance) + parseFloat(manual) + parseFloat(perf) + parseFloat(automation) + parseFloat(infra)));
...
document.getElementById("complexity").addEventListener("change", function() { thumbFFunction.call(this, "complexity"); });
document.getElementById("uncertainty").addEventListener("change", function() { thumbFFunction.call(this, "uncertainty"); });
document.getElementById("security").addEventListener("change", function() { thumbCFunction.call(this, "security"); });
document.getElementById("controls").addEventListener("change", function() { thumbCFunction.call(this, "controls"); });
document.getElementById("unfamiliarity").addEventListener("change", function() { thumbDFunction.call(this, "unfamiliarity"); });
document.getElementById("quality").addEventListener("change", function() { thumbFFunction.call(this, "quality"); });
document.getElementById("dependencies").addEventListener("change", function() { thumbCFunction.call(this, "dependencies"); });
document.getElementById("performance").addEventListener("change", function() { thumbDFunction.call(this, "performance"); });
document.getElementById("manual").addEventListener("change", function() { thumbBFunction.call(this, "manual"); });
document.getElementById("perf").addEventListener("change", function() { thumbAFunction.call(this, "perf"); });
document.getElementById("automation").addEventListener("change", function() { thumbEFunction.call(this, "automation"); });
document.getElementById("infra").addEventListener("change", function() { thumbBFunction.call(this, "infra"); });
